...
//float turn_kp	=		20.0f ;	//���ں���Թ�ʶ��켣ʱ,����Ѱ����λ�ÿ�������������KP	 λ�ÿ�����
//float turn_ki	=		0.0f	;	//���ں���Թ�ʶ��켣ʱ,����Ѱ����λ�ÿ��������ֲ���KI	
//float turn_kd	=		110		;	//���ں���Թ�ʶ��켣ʱ,����Ѱ����λ�ÿ�����΢�ֲ���KD	
//20�ٶ�
float turn_kp	=	3.9f ;	//���ں���Թ�ʶ��켣ʱ,����Ѱ����λ�ÿ�������������KP	 λ�ÿ�����
float turn_ki	=	0.0f;	//���ں���Թ�ʶ��켣ʱ,����Ѱ����λ�ÿ��������ֲ���KI	
float turn_kd	=	5.2f;	//���ں���Թ�ʶ��켣ʱ,����Ѱ����λ�ÿ�����΢�ֲ���KD	

float turn_kp_L	=	2.f	;	//���ں���Թ�ʶ��켣ʱ,����Ѱ����λ�ÿ�������������KP	 λ�ÿ�����
float turn_ki_L	=	0.0f		;	//���ں���Թ�ʶ��켣ʱ,����Ѱ����λ�ÿ��������ֲ���KI	
float turn_kd_L	=	0.6f	;	//���ں���Թ�ʶ��켣ʱ,����Ѱ����λ�ÿ�����΢�ֲ���KD
...
void gray_turn_control_200hz(float *output)//200HZ=5ms
{
	...
	//ת��PD����������������ʵʱ��Ҫ��ߣ��������I��ʹ������Ӧ�ͺ�
	seektrack_ctrl[0].expect=0;							//����   seektrack��ѭ������˼
	seektrack_ctrl[0].feedback=-gray_status;	//���� gray_status[0]������Ԫ��״ֵ̬-11~11
...
//	if(turn_output<0) turn_output-=steer_deadzone;
	//����޷�?
	turn_output=Xianfu_float(turn_output,70);//ת�����turn_ctrl_pwm����޷�?
	
	*output=0.75f*turn_output+0.25f*turn_output_last;//����?ǰ�����μ���ľ��?
}
float cam_turn_kp	=		0.f ;	//���ں���Թ�ʶ��켣ʱ,����Ѱ����λ�ÿ�������������KP	 λ�ÿ�����
float cam_turn_ki	=		0.0f	;	//���ں���Թ�ʶ��켣ʱ,����Ѱ����λ�ÿ��������ֲ���KI	
float cam_turn_kd	=		0.0f;	//���ں���Թ�ʶ��켣ʱ,����Ѱ����λ�ÿ�����΢�ֲ���KD	
...
void nmotor_output(void)
{
	...
	{	
		if(speed_output[1])
			right_pwm= 4 * (speed_output[1] / ABS(speed_output[1])) + speed_output[1]; //�����ٶȵ�������
		else
			right_pwm = 0;
		
		if(speed_output[0])
			left_pwm= 4 * (speed_output[0] / ABS(speed_output[0])) + speed_output[0]; //�����ٶȵ�������	
		else
			left_pwm = 0;	
