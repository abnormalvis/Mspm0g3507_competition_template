...
void hal_KeyInit(void)
{
    ...
    /* Manual GPIO init: key pins as input with pull-up + falling-edge interrupt.
       Was generated by sysconfig before KEY GPIO group was removed. */
    ...
    DL_GPIO_initDigitalInputFeatures(IOMUX_PINCM31,
        DL_GPIO_INVERSION_DISABLE, DL_GPIO_RESISTOR_PULL_UP,
        DL_GPIO_HYSTERESIS_DISABLE, DL_GPIO_WAKEUP_DISABLE);
    DL_GPIO_initDigitalInputFeatures(IOMUX_PINCM38,
        DL_GPIO_INVERSION_DISABLE, DL_GPIO_RESISTOR_PULL_UP,
        DL_GPIO_HYSTERESIS_DISABLE, DL_GPIO_WAKEUP_DISABLE);
    DL_GPIO_initDigitalInputFeatures(IOMUX_PINCM42,
        DL_GPIO_INVERSION_DISABLE, DL_GPIO_RESISTOR_PULL_UP,
        DL_GPIO_HYSTERESIS_DISABLE, DL_GPIO_WAKEUP_DISABLE);
    DL_GPIO_initDigitalInputFeatures(IOMUX_PINCM45,
        DL_GPIO_INVERSION_DISABLE, DL_GPIO_RESISTOR_PULL_UP,
        DL_GPIO_HYSTERESIS_DISABLE, DL_GPIO_WAKEUP_DISABLE);

    DL_GPIO_setLowerPinsPolarity(GPIOB,
        DL_GPIO_PIN_13_EDGE_FALL | DL_GPIO_PIN_14_EDGE_FALL);
    DL_GPIO_setUpperPinsPolarity(GPIOB,
        DL_GPIO_PIN_17_EDGE_FALL | DL_GPIO_PIN_19_EDGE_FALL | DL_GPIO_PIN_20_EDGE_FALL);

    {
        uint32_t key_pin_mask = KEY_KEY_UP_PIN | KEY_KEY_DOWN_PIN | KEY_KEY_LEFT_PIN |
                                KEY_KEY_RIGHT_PIN | KEY_KEY_MID_PIN;
        DL_GPIO_clearInterruptStatus(KEY_PORT, key_pin_mask);
        DL_GPIO_enableInterrupt(KEY_PORT, key_pin_mask);
    }
