...
void StepperMotor1_SetPos(float Angle){
    if(Angle >0){
        Emm_V5_Pos_Control(1, 0,2000, 0, (uint32_t)(Angle/360*12800), 0, 0);
    }else if(Angle <0){
        Emm_V5_Pos_Control(1, 1,2000, 0, (uint32_t)(-Angle/360*12800), 0, 0);
    }
};
void StepperMotor2_SetPos(float Angle){
    if(Angle >0){
        Emm_V5_Pos_Control(2, 0, 2000, 0, (uint32_t)(Angle/360*12800), 0, 0);
    }else if(Angle <0){
        Emm_V5_Pos_Control(2, 1, 2000, 0, (uint32_t)(-Angle/360*12800), 0, 0);
    }
};
//以以一定速度转动
void StepperMotor1_SetVel(float vel){
    ...
    if(vel >= 0&&vel <= 5000){
        Emm_V5_Vel_Control(1,0,ROUND(vel),250,0);
    }else{
        Emm_V5_Vel_Control(1,1,ROUND(-vel),250,0);
    }
};
void StepperMotor2_SetVel(float vel){
    #define ROUND(x) (int)(x + 0.5f)
    if(vel >= 0&&vel <= 5000){
        Emm_V5_Vel_Control(2,0,ROUND(vel),250,0);
    }else if(vel <=0&&vel >= -5000){
        Emm_V5_Vel_Control(2,1,ROUND(-vel),250,0);
    }
};